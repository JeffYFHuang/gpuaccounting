...
@Entity
@Table(name = "currentgpumetrics")
public class CurrentGpumetric {
    @Id
    ...
    @JoinColumn(name = "gpu_id", insertable = false, updatable = false)
    @JsonBackReference
    private GPU gpu;

    public CurrentGpumetric() {
    }

    @Override
    public String toString() {
        return "CurrentGpumetric{" +
                "id=" + id +
                ", gpuId=" + gpuId +
